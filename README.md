...
--graceful                -g  While creating DynamoDB tables do not exit with error on pre-exiting tables
...
custom:
  dynamodb:
    start:
      ...
      migrate: true
      seed: true
      graceful: true # Allows to add tables to existing DynamoDB without errors
