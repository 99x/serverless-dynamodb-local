...
class ServerlessDynamodbLocal {
          ...
          start: {
            ...
            options: {
              ...
              dbPath: {
                shortcut: "d",
                usage:
                  "The directory where DynamoDB will write its database file. If you do not specify this option, the file will be written to the current directory. Note that you cannot specify both -dbPath and -inMemory at once. For the path, current working directory is <project-root>/node_modules/serverless-dynamodb-local/dynamodb. For example to create <project-root>/node_modules/serverless-dynamodb-local/dynamodb/<my-path> you should specify -d <my-path>/ or --dbPath <my-path>/ with a forward slash at the end."
              },
              sharedDb: {
                shortcut: "h",
                usage:
  ...
  hasAdditionalStacksPlugin() {
    return _
      .get(this.service, "plugins", [])
      .includes("serverless-plugin-additional-stacks");
  }
